...
def main():
    ...
    for step in range(config_total_step):
        ...
        print(target_features[0].shape)
        print(target_features[1].shape)
        print(target_features[2].shape)
        print(target_features[3].shape)
        print(target_features[4].shape)
